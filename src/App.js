...
import TermsAndConditionsPage from './component/pages/TermsAndConditionsPage';
...
function App() {
  return (
    ...
    <CartProvider> 
      <Navbar/>
        <Routes>
          {/* OUR ROUTES */}          <Route exact path='/' element={<Home/>}/>
          <Route path='event/:id' element={<EventDetailsPage/>}/>
          <Route path='/categories' element={<CategoryListPage/>}/>
          <Route path='/category/:categoryId' element={<CategoryEventsPage/>}/>          <Route path='/about-us' element={<AboutUsPage/>}/>
          ...
          <Route path='/admin/purchase-details/:itemId' element={<AdminRoute element={<AdminPurchaseDetailsPage/>} />} />        </Routes>
